...
**(This is copied from the briar-mailbox README.md. I did not create the Briar Project and I have no affliation with them.)**
...
Howver, here's the hardware info direct from the Briar Project README:
